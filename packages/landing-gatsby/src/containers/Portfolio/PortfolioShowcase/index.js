...
const PortfolioShowcase = ({
  ...
  return (
    <Box {...sectionWrapper} as="section" id="portfolio_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Réalisations" />
          <Text
            {...secDescription}
            content="Voici ce que j'ai pu réaliser en terme de projets concrets.
            A savoir que mon plus gros projet est en Front end (React/Redux/Redux Saga/AntDesign )et 
            je travaille toujours dessus à ce jour en freelance. Le Back end n'est pas un problème non plus car j'ai déjà travaillé en serverless avec Firebase, Prisma et AWS3."
          />
        </Box>
                        ...
                        <PortfolioShowcaseItem>
                          ...
                          portfolioItem.feedback ? (
                            <PortfolioMeta>
                              ...
                              {portfolioItem.view ? (
                                portfolioItem.view === "1" ? 
                                <MetaItem>
                                  <b>{portfolioItem.view}</b> Dev Front end
                                </MetaItem> : 
                                <MetaItem>
                                  <b>{portfolioItem.view}</b> Devs Front end
                                </MetaItem>
                              ) : (
                                ''
                              )}
                              {portfolioItem.love ? (
                                portfolioItem.love === "1" ? 
                                <MetaItem>
                                  <b>{portfolioItem.love}</b> Dev Back end
                                </MetaItem> : 
                                <MetaItem>
                                  <b>{portfolioItem.love}</b> Devs Back end
                                </MetaItem>
                              ) : (
                                ''
                              )}
