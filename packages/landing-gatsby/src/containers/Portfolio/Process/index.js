    ...
    <Box {...sectionWrapper} as="section" id="process_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading
            {...secTitle}
            content="De Manager dans la grande distribution à Développeur web"
          />
          <Text
            {...secDescription}
            content="Voici mon parcours en quelques mots"
          />
        </Box>
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            <Heading
              content="C'est pourquoi, je continue à me former"
              {...learningTitle}
            />
            <Text
              content="La connaissance et l'expérience viennent en pratiquant."
              {...learningSubTitle}
            />
            <Text
              {...learningDescription}
              content="Issu d’un Bac S, j’ai de suite changé de voie en allant sur une fac de droit (1an) avant de faire un BTS MUC ainsi qu’une licence DISTECH spécialisée dans la grande distribution pour rentrer à Carrefour. Au bout de ces 9 ans, et riche de cette expérience, j’ai décidé de me réorienter professionnelement pour donner un nouveau challenge à ma vie et découvrir un nouveau monde: celui de développeur web où la curiosité et l’apprentissage continue, sont les maîtres mots des métiers qui en découlent."
            />
            <Text
              {...learningDescription}
              content="Je continue à travailler en tant que développeur front-end React Js tout en ayant une veille technologique et en me formant de plus en plus sur les applications serverless."
            />
            <Box {...buttonWrapper}>
              <Text content="Me contacter" {...buttonLabelStyle} />
              <ButtonWrapper>
                <Button
                  title="Evan"
                  className="portfolio_button"
