...
import { ButtonWrapper } from '../../Portfolio/portfolio.style';
import { ActiveStatus } from './contact.style';
import Author from 'common/src/assets/image/portfolio/moi1.jpg';
    ...
    <Box {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          ...
          <Text
            {...secDescription}
            content="Envie d'aggrandir votre équipe de développeurs, ou si vous avez des idées d'applications (sites), n'hésitez pas, contactez moi !"
          />
        </Box>
        <Box {...replyWrapper}>
          <ActiveStatus>
            <Image src={Author} alt="Evan" />
          </ActiveStatus>
          <Heading
            as="h4"
            content="Contactez moi et voyons nos disponibilités"
            {...replyTime}
          />
        </Box>
        <Box {...buttonWrapper}>
