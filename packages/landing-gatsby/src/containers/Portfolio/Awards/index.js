    ...
    <AwardSectionWrapper id="awards_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading
            {...secTitle}
            content="Technos &amp; Stacks"
          />
          <Text
            {...secDescription}
            content="Voici les différents technos utilisées, ma stack la plus utilisée est en serverless avec Prisma/Firebase pour le Back et React Js/Redux pour le Front"
          />
        </Box>
